      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <a href="<?php echo site_url('Dashboard/exportPdf')?>" class="btn btn-sm btn-warning shadow-sm" style="margin-right: -75%;">
            <i class="fas fa-download fa-sm text-white-50"></i> Generate PDF
        </a>
        <a href="<?php echo site_url('Dashboard/exportExcel')?>" class="btn btn-sm btn-success shadow-sm" >
                ...
                ?>
                    <tr>
                        ...
                        <td class="text-center">
                          <a href="<?php echo site_url('Dashboard/tanggapi') ?>" class="btn btn-info btn-icon-split">
