...
<div class="card" style="width: 30rem; height: 30rem">
  <div class="card-body">
    ...
    <br>
    <p style="margin-left:-178px;">Email</p>
    <input type="text" name="Email" placeholder="Email" style="width:220px;">
    ...
    <div>
        ...
        <br>
        <div>
    <p  class="card-link" style="color:black;">Tidak Memiliki Akun? <a href="<?php echo site_url('Dashboard/register')?>">Daftar </a></p>
  </div>
</div>
</form>
