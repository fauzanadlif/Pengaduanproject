  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="<?php echo site_url('Dashboard/petugas_tanggapan');?>">
          ...
          <div class="container-fluid">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary text-left">Tulis Laporan
                    <a href="<?php echo site_url('Dashboard/petugas_tanggapan') ?>" class="text-danger float-right">
                ...
                <div class="card-body">
                    ...
                    <button style="width: 15%;" value="reset" class="btn btn-small btn-danger btn-block" type="reset"><i
                     class="far fa-save"></i><span class="ml-2">Reset</span></button>
