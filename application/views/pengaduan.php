  ...
  <body>
                ...
                <div class="modal-body">
                  ...
                  <form action="" method="post" id="form">
                    ...
                    <div class="form-group">
                      ...
                      <input type="pengaduan" id="pengaduan" class="form-control">
                    </div>
                  </form>
                </div>
                <div class="modal-footer">
                  <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                  <button type="button" class="btn btn-primary" id="add">Ajukan Pengaduan</button>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <form action="" method="post" id="edit_form">
              ...
              <div class="form-group">
                <label for="">NIK</label>
                <input type="pengaduan" id="edit_nik" class="form-control">
              </div>
              <div class="form-group">
                <label for="">pengaduan</label>
                <input type="pengaduan" id="edit_pengaduan" class="form-control">
              </div>
    ...
    <script>
        ...
        $.ajax({
          ...
          success: function(data){
            if (data.responce == "success") {
                ...
                $("#edit_pengaduan").val(data.post.pengaduan);
              }else{
                toastr["error"](data.message);
              }
          }
      ...
      $(document).on("click", "#update", function(e){
        ...
        var edit_pengaduan = $("#edit_pengaduan").val();

        if (edit_record_id == "" || edit_name == "" || edit_pengaduan == "") {
          alert("Both field is required");
        }else{
          $.ajax({
