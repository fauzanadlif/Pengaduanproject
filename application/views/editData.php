  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        ...
        <div class="sidebar-brand-text mx-3">Aduin Yuk!</div>
      </a>
      ...
      <li class="nav-item active">
        <a class="nav-link" href="<?php echo site_url('Dashboard/tampilan_user');?>">
      ...
      <!-- Nav Item - Charts -->
      <li class="nav-item">
        <a class="nav-link" href="<?php echo site_url('Dashboard/tulis_pengaduan');?>">
          ...
          <div class="container-fluid">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary text-left">Edit Laporan</h6>
                </div>
                <div class="card-body">
                  <?php foreach ($user as $datas) { ?>
                    <form class=" form-signin" action="<?php echo site_url('Dashboard/update_pengaduan/' . $datas->id)?>" method="POST" enctype="multipart/form-data">
                       
        
                        <div class="form-group">
                            <label for="">Tanggal Pengaduan</label>
                            <input type="text" class="form-control" id="date"
                                name="date" value="<?php echo $datas->tanggal ?>">
                        ...
                        <div class="form-group">
                          <label for="">NIK</label>
                          <input type="text" class="form-control" id="date"
                              name="nik" value="<?php echo $datas->nik?>">
                          
                      </div>
        
                      <div class="form-group">
                        <label for="">Tulis Laporan</label>
                        <textarea class="form-control" type="text"  id="" name="isiLaporan" id="" cols="30" rows="7"><?php echo $datas->laporan?></textarea>
                    ...
                    <?php } ?>
                    <br>
                    <a href="<?php echo site_url('Dashboard/laporan') ?>" class="text-danger float-right">
